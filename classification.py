...
if __name__ == '__main__':
    ...
    elif idxModel == 'unitNorm':
        from local_models import unitNorm as modelFactory
    ...
    for epoch in range(Nepochs):  # loop over the dataset multiple times
        ...
        for i, data in enumerate(trainloader, 0):
            ...
            print('[epoch %d / %d, mini-batch %5d / %d] loss: %.3e' % (
            epoch + 1, Nepochs, i + 1, len(trainloader), running_loss))
            running_loss = 0.0
