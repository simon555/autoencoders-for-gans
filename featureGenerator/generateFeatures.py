...
class ModelAE(nn.Module):
    ...
    def __init__(self, output_channels=3, in_channels=3, depth=5, 
        ...
        print('model loaded : feature Generator ')
    ...
    def getFeatureAtStep(self,i,image):
        for j, module in enumerate(self.down_convs):
             if j<=i:
                 image, output = module(image)
        return(output)
...
if __name__ == "__main__":
    ...
    model = ModelAE(depth=5, merge_mode='concat')
    if model.useCuda:
