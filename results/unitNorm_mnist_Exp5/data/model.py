...
class myLinear(nn.Module):
    ...
    def forward(self, input):
        ...
        coef=x*y
        return F.linear(input, self.weight/coef, self.bias)
...
class Model(nn.Module):
    ...
    def forward(self, image):
        ...
        image = F.sigmoid(self.layer1(image))
        image = F.sigmoid(self.layer2(image))
        image = F.sigmoid(self.layer3(image))
        image = F.sigmoid(self.layer4(image))
        image = F.sigmoid(self.layer5(image))
